...
extern "C" BOOL g_bMSAA;
extern "C" BOOL g_bSMAA;
extern "C" BOOL g_bSSAO;
...
public:
	Direct3DDevice8(Direct3D8 *d3d, IDirect3DDevice9 *ProxyInterface, DWORD BehaviorFlags, D3DPRESENT_PARAMETERS *PresentParams);
	~Direct3DDevice8();
...
private:
	...
	IDirect3DTexture9* rgbaBuffer2Tex;
	IDirect3DSurface9* rgbaBuffer2Surf;
	IDirect3DTexture9* depthBuffer1Tex;
	IDirect3DSurface9* depthBuffer1Surf;
	IDirect3DSurface9* depthStencilSurf;
	IDirect3DSurface9 *pMainRenderTarget = nullptr;
	IDirect3DSurface9 *pMainDepthStencilSurf = nullptr;
};
